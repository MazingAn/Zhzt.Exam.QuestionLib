    ...
    <el-dialog :title="type == 'add' ? '添加题目' : '修改题目'" v-model="visible" width="600px">
        <el-form :model="ruleForm" :rules="rules" ref="formRef" label-width="100px">
            ...
            <el-form-item label="正确答案" prop="rightAnswer">
                <el-select v-model="selectedRightAnswers" multiple @change="handleRightAnswerChange">
    ...
    setup(props) {
        ...
        const state = reactive({
            ...
            rules: {
                ...
                answer3: [{ required: true, message: '选项C不能为空', trigger: 'blur' }],
                answer4: [{ required: true, message: '选项D不能为空', trigger: 'blur' }],
        ...
        const open = (currentData) => {
            ...
            if (currentData) {
                ...
                state.selectedRightAnswers = currentData.rightAnswer.split('$')
            } else {
                state.ruleForm = {
                    questionBody: "",
                    questionTypeId: "",
