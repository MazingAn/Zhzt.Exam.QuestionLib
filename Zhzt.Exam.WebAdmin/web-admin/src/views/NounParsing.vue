<template>
    <el-card>
        <QuesList ref="quesListRef" :hasHeader="true" :tableTitle="'名词解释题目列表'" :pageSize="10" :questionClass="6"
    ...
    <QuesNounParsingAddDlg ref="quesEditRef" :reload="reload" :allQuestionTypes="allQuestionTypes" :type="editType"/>
</template>
...
import QuesNounParsingAddDlg from "../components/QuesNounParsingAddDlg.vue";

export default {
    name: 'NounParsing',
    components: { QuesList, QuesNounParsingAddDlg },
    setup() {
