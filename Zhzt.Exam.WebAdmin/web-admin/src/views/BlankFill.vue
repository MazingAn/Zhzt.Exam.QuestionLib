<template>
    <el-card>
        <QuesList ref="quesListRef" :hasHeader="true" :tableTitle="'填空题题目列表'" :pageSize="10" :questionClass="4"
...
import QuesBlkFillAddDlg from "../components/QuesBlkFillAddDlg.vue";

export default {
    name: 'BlankFill',
    components: { QuesList, QuesBlkFillAddDlg },
    setup() {
