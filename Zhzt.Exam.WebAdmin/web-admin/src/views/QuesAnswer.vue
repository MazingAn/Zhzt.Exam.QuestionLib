<template>
    <el-card>
        <QuesList ref="quesListRef" :hasHeader="true" :tableTitle="'问答题题目列表'" :pageSize="10" :questionClass="5"
    ...
    <QuesQuesAnsAddDlg ref="quesEditRef" :reload="reload" :allQuestionTypes="allQuestionTypes" :type="editType"/>
</template>
...
import QuesQuesAnsAddDlg from "../components/QuesQuesAnsAddDlg.vue";

export default {
    name: 'QuesAnswer',
    components: { QuesList, QuesQuesAnsAddDlg },
    setup() {
