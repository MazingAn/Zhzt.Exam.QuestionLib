<template>
    <el-card>
        <QuesList ref="quesListRef" :hasHeader="true" :tableTitle="'判断题题目列表'" :pageSize="10" :questionClass="3"
    ...
    <QuesJudgeAddDlg ref="quesEditRef" :reload="reload" :allQuestionTypes="allQuestionTypes" :type="editType"/>
</template>
...
import QuesJudgeAddDlg from "../components/QuesJudgeAddDlg.vue";

export default {
    name: 'Judge',
    components: { QuesList, QuesJudgeAddDlg },
    setup() {
